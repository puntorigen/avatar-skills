#!/usr/bin/env python3
"""Store the Replicate API token for the video-bg-replace skill.
...
(broll-generator, avatar-talking-video, voice-clone, gpt-image-2, ...) already
has a valid token configured, this skill discovers it automatically and you do
not need to run this. Run it only to set or refresh the token.
"""
