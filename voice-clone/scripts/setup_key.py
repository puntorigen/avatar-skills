#!/usr/bin/env python3
"""Store the Replicate API token for the voice-clone skill.
...
(avatar-video-reel, gpt-image-2, bg-music, sound-effects, ...) already has a
valid token configured, this skill discovers it automatically and you do not
need to run this. Run it only to set or refresh the token.
"""
