#!/usr/bin/env python3
"""Optional credential setup for the carousel-generator skill.
...
Usage:
    ...
    python3 setup_key.py --gemini-api-key AIza... --apify-token apify_...
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Configure carousel-generator credentials (optional)")
